...
int main() {
    ...
    j = n1.next->value;
    printf("The value of the second node (n2) is: %d\n", j);

    // Printing values of the next nodes
    printf("The value of n2 (next of n1): %d\n", n1.next->value); // n2 value
    printf("The value of n3 (next of n2): %d\n", n2.next->value); // n3 value

    // Printing values of the previous nodes
    // n1.previous is NULL, so we should avoid dereferencing it.
    // printf("%d\n", n1.previous->value); // This would cause a segmentation fault

    printf("The value of n1 (previous of n2): %d\n", n2.previous->value); // n1 value
    printf("The value of n2 (previous of n3): %d\n", n3.previous->value); // n2 value
